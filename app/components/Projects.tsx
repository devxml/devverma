...
const Projects = () => {
  ...
  const projects: Projects[] = [
    ...
    },
    {
      name: "WellnessAI",
      about:
        "India's first AI-powered wellness platform, generating personalised diet, skincare, and haircare plans built around Indian ingredients and brands using a LangGraph agent with RAG.",
